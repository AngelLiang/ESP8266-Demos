...
{
    return coap_make_response(scratch, outpkt, (const uint8_t *)rsp, os_strlen(rsp), id_hi, id_lo, &inpkt->tok, COAP_RSPCODE_CONTENT, COAP_CONTENTTYPE_APPLICATION_LINKFORMAT);
}
...
/*
 * function: handle_get_light
 * description: light资源get方法处理函数
 */
...
/*
 * function: handle_put_light
 * description: light资源put方法处理函数
 */
